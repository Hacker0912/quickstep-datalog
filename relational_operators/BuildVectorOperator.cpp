    ...
    for (std::size_t part_id = 0; part_id < num_partitions_; ++part_id) {
      ...
      for (const block_id block : input_relation_block_ids_[part_id]) {
        container->addNormalWorkOrder(
            new BuildVectorWorkOrder(query_id_, input_relation_, join_key_attribute_,
                                     join_key_attribute_nullable_, part_id, block, hash_table, storage_manager,
...
serialization::WorkOrder* BuildVectorOperator::createWorkOrderProto(const block_id block, const partition_id part_id) {
  ...
  proto->SetExtension(serialization::BuildVectorWorkOrder::join_key_attribute, join_key_attribute_);
  proto->SetExtension(serialization::BuildVectorWorkOrder::join_key_attribute_nullable,
