...
class BuildVectorOperator : public RelationalOperator {
 public:
   ...
   *        workorders.
   * @param join_key_attribute The equijoin attribute id in input_relation.
   ...
   *        join_key_attribute in input_relation.
   **/
...
class BuildVectorWorkOrder : public WorkOrder {
 public:
   ...
   * @param input_relation The relation to build hash table on.
   * @param join_key_attribute The IDs of equijoin attributes in
   *        input_relation.
   * @param join_key_attribute_nullable If any attribute is nullable.
